	...
	tests := []struct {
		...
		},
		{
			...
			reviews: []github.Review{
				...
				github.Review{Author: "4", State: approved},
			},
			result: false,
		},
		{
			...
			author: "5",
			reviews: []github.Review{
				github.Review{Author: "1", State: approved},
				github.Review{Author: "4", State: approved},
			},
			result: false,
		},
		{
			...
			author: "5",
			reviews: []github.Review{
				github.Review{Author: "1", State: changesRequested},
...
func TestCheckInternal(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			author: "4",
			reviews: []github.Review{
				github.Review{Author: "7", State: approved},
			},
			docs:   true,
			code:   false,
			result: true,
		...
		},
		{
			...
			author: "4",
			reviews: []github.Review{
				github.Review{Author: "5", State: approved},
				github.Review{Author: "6", State: approved},
			},
			docs:   false,
			code:   true,
			result: false,
		},
		{
			...
			reviews: []github.Review{
				github.Review{Author: "3", State: approved},
				github.Review{Author: "4", State: changesRequested},
			},
			docs:   false,
			code:   true,
			result: false,
		...
		},
		{
			...
			reviews: []github.Review{
				github.Review{Author: "3", State: approved},
				github.Review{Author: "9", State: approved},
			},
			docs:   false,
			code:   true,
			result: true,
		},
		{
			...
			reviews: []github.Review{
				github.Review{Author: "3", State: approved},
				github.Review{Author: "9", State: approved},
				github.Review{Author: "9", State: commented},
			},
			docs:   false,
			code:   true,
			result: true,
		},
		{
			...
			author: "10",
			reviews: []github.Review{
				github.Review{Author: "11", State: approved},
				github.Review{Author: "12", State: approved},
			},
			docs:   false,
			code:   true,
			result: false,
